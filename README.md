...
Note: this section includes gifs that GitHub cannot display at this time, but which should display fine when the repository is cloned and this file is opened locally in most modern IDEs. If viewing on GitHub only, the examples are available [here](resources/pos_site_US.mp4), [here](resources/pos_site_BR.mp4), and [here](resources/pos_site_AE.mp4) for download.
